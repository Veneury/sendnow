 ...
 * @author TooDe
 */
public class frmfiltrareditarTipoPaquetes extends javax.swing.JFrame {

    /** Creates new form frmagregado */
    public frmfiltrareditarTipoPaquetes() {
        initComponents();
    }
   ...
   private void initComponents() {
      ...
      jLabel1.setText("Nombre tipo paquete");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmfiltrareditarTipoPaquetes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmfiltrareditarTipoPaquetes().setVisible(true);
            }
        });
    }
