 ...
 * @author TooDe
 */
public class frmEditartipoPaquete extends javax.swing.JFrame {

    /** Creates new form frmagregado */
    public frmEditartipoPaquete() {
        initComponents();
    }
   ...
   private void initComponents() {
      ...
      jLabel20.setText("Editar tipos de paquetes");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmEditartipoPaquete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmEditartipoPaquete().setVisible(true);
            }
        });
    }
