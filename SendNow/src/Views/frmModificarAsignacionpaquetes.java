 ...
 * @author TooDe
 */
public class frmModificarAsignacionpaquetes extends javax.swing.JFrame {

    /** Creates new form frmagregado */
    public frmModificarAsignacionpaquetes() {
        initComponents();
    }
   ...
   private void initComponents() {
      ...
      jLabel20.setText("Modificar paquetes a clientes");
      ...
      rSDateChooser1.setPlaceholder("2018/10/08");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmModificarAsignacionpaquetes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmModificarAsignacionpaquetes().setVisible(true);
            }
        });
    }
