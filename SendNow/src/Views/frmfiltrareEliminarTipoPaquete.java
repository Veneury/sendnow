 ...
 * @author TooDe
 */
public class frmfiltrareEliminarTipoPaquete extends javax.swing.JFrame {

    /** Creates new form frmagregado */
    public frmfiltrareEliminarTipoPaquete() {
        initComponents();
    }
   ...
   private void initComponents() {
      ...
      jLabel20.setText("Eliminar tipos de paquetes");
   ...
   private void materialButtomRectangle2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_materialButtomRectangle2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(frmfiltrareEliminarTipoPaquete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new frmfiltrareEliminarTipoPaquete().setVisible(true);
            }
        });
    }
